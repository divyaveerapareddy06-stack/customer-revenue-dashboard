-- Project: Customer Segmentation & Sales Analysis
-- Database: MySQL
-- Objective: Analyze customer behavior, revenue trends, and top contributors
...
-- Average Order Value of all orders
...
-- Customer with more than 1 order and maximum revenue
...
-- Products frequently bought by customers who placed more than 1 order
